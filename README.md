...
- **情景世界卡**：世界资料可按当前叙事关键词、幕／拍、路线、阵营和局内对象激活，并分别进入世界常量、场景资料、真实短篇表达样例或当前关注位置；有限 Sticky 与随后的 Cooldown 保持连续性而不让同一线索无限自我续期。
...
仓库内置三套 v8 叙事世界包。每套世界包独立提供文风、三幕主线、阵营、开放路线、情景世界卡、成长方向、生存规则和三档结局。
...
3. 在叙事包中配置文风、三幕职责、阵营、开放路线、可按情景激活的世界卡、成长方向、生存规则和好/普通/坏结局蓝图。
